<script>
  ...
  // Update automaton information if infiniscroll is executing
  ...
  function generate() {
    ...
    canvas.displayAutomaton(generations, Number(genDelay))
  }
</script>
...
<main>
  ...
  <form>
    <div class='config-set'>
      ...
      <ConfigInput
        ...
        inputProps={{
          ...
          min: 3,
          placeholder: 300,
          disabled: infiniscroll && automatonLoading
        }}
    ...
    <div class='config-set'>
      ...
      <ConfigInput
        ...
        inputProps={{
          ...
          min: 1,
          placeholder: 1,
          disabled: completeRandomInitialSeed || (infiniscroll && automatonLoading),
        }}
      ...
      >
        <select bind:value={borderCellValue} id='border-cell-value' slot='input-override'
          style={'padding: .2em; font-size: 1em; border-radius: .25em;'}
        >
    ...
    <div class='automaton-info'>
      ...
      <span>Class: {ruleClassification ?? 'Unknown'}</span>
